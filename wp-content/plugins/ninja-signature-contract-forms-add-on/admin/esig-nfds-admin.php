    ...
    class ESIG_NFDS_Admin extends ESIG_NF_SETTING {
        ...
        public function enqueue_admin_styles() {
            ...
            $admin_screens = array(
                ...
                'ninja-forms_page_esign-ninja-about',
        ...
        final function render_shortcode_esigninja($atts) {
            ...
            $nf_value = self::get_value($document_id, $field_id, $display, $option);
            ...
            return self::display_value($notification_id, $form_id, $finalValue);
        }
        ...
        public function esig_invite_document($old_doc_id, $siner_email, $signer_name, $form_id, $post_id, $signing_logic, $notification_id) {
            ...
            $submission = get_post_meta($post_id);
            $api->meta->add($doc_id, 'esig_ninja_submission_value', serialize($submission));
